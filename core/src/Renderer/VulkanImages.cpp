...
namespace FWE::Renderer::Vulkan::Utils
{
    ...
    void TransitionImage(VkCommandBuffer cmd, VkImage image, VkImageLayout currentLayout, VkImageLayout newLayout)
    {
        ...
        VkDependencyInfo dependencdyInfo {};
        dependencdyInfo.sType = VK_STRUCTURE_TYPE_DEPENDENCY_INFO;
        dependencdyInfo.pNext = nullptr;

        dependencdyInfo.imageMemoryBarrierCount = 1;
        dependencdyInfo.pImageMemoryBarriers = &imageBarrier;

        vkCmdPipelineBarrier2(cmd, &dependencdyInfo);
    }
