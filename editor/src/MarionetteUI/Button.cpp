...
namespace FWE::MarionetteUI
{
    ...
    Button::Button(glm::vec2 position, glm::vec2 size, const char *str, Font font, Renderer::Image image, bool tile, HorizontalAlignment horizontalAlignment, VerticalAlignment verticalAlignnment) : 
    label(position, str, font, horizontalAlignment, verticalAlignnment), 
